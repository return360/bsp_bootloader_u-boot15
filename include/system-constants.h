...
#define
#else
// MODIFICATION: using vars that might actually exist in the system
#ifdef CONFIG_SYS_INIT_SP_ADDR
#define SYS_INIT_SP_ADDR CONFIG_SYS_INIT_SP_ADDR
#else
#define SYS_INIT_SP_ADDR (CFG_SYS_INIT_RAM_ADDR + CFG_SYS_INIT_RAM_SIZE - GENERATED_GBL_DATA_SIZE)
#endif
